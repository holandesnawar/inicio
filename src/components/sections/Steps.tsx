...
const STEP_VH  = 50;            // each step = 50vh
const PAD_VH   = 25;            // top + bottom padding = 25vh each
const SECTION_VH = 2 * PAD_VH + N * STEP_VH; // 300

/* ── Per-step visual objects ── */
const StepVisual01 = () => (
...
export default function Steps() {
  ...
  // Opacity: 1 for centered step, fades toward 0.15 for distant ones
  ...
  // translateY: active step at 0, incoming step pushed down (rises toward 0), outgoing pushed up
  ...
  return (
    <section id="metodo" data-navbar="dark" className="relative bg-[#1D0084]">
      ...
      <div
        ...
        style={{
          background:
            "radial-gradient(ellipse 70% 45% at 50% 0%, rgba(11,109,240,0.22) 0%, transparent 70%)",
        }}
      />
      ...
      {/* ══════════════════════════════════
          DESKTOP — tall wrapper + sticky
          "window" with strip scrolling inside
      ══════════════════════════════════ */}
      <div
        ref={desktopRef}
      ...
      >
        {/* Sticky viewport — the "window" */}
        <div className="sticky top-0 h-screen overflow-hidden flex">

          {/* ── LEFT STRIP ── */}
          <div className="w-1/2 overflow-hidden relative">
            {/* Section header — pinned above the strip, visible only at top */}
            <div
            ...
            <div
              style={{
                ...
                paddingTop:    `${PAD_VH}vh`,
                paddingBottom: `${PAD_VH}vh`,
              }}
            >
              {STEPS.map((step, i) => (
                <div
                ...
                >
                  ...
                  <h2 className="title-sm text-white leading-snug max-w-xs">
                    {step.title}
                  </h2>
                </div>
              ))}
          ...
          {/* ── CENTER LINE (fixed — does not translate) ── */}
          <div
            aria-hidden
          ...
          >
            ...
            {/* Animated glowing dot — moves smoothly with scroll */}
            <div
              className="absolute"
              style={{
                left:       "50%",
            ...
            >
              <div
                ...
                style={{
                  boxShadow:
                    "0 0 0 5px rgba(77,163,255,0.18), 0 0 18px rgba(77,163,255,0.55)",
                }}
              />
            </div>
          </div>
          ...
          {/* ── RIGHT STRIP ── */}
          <div className="w-1/2 overflow-hidden relative">
            {/* Translating strip — same ty as left */}
            <div
              style={{
                transform:     `translateY(${ty}px)`,
                paddingTop:    `${PAD_VH}vh`,
            ...
            >
              {STEPS.map((step, i) => {
                ...
                return (
                  ...
                  >
                    <p className="text-[17px] text-white/85 leading-[1.75] max-w-sm mb-6">
                      {step.description}
                    </p>
